...
| -------- | -------- | -------------- | --------- | ------------ | ------------------ | ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | ------------------------ |
| Semana 1 | Sprint 1 | Backend        | bloqueado | 2026-03-30   | 2026-04-05         | npm run test: Tests: 7 failed, 51 passed, 58 total / Snapshots: 0 total / Time: 0.544 s, estimated 1 s / Ran all test suites. | auto(lint:ok,test:fail,system-check:fail) local-run | 2026-03-30T16:50:27.911Z |
