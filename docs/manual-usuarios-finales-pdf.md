...
Esta guia esta pensada para personas usuarias (no tecnicas).  
Te ayudara a empezar rapido, usar bien el chat y resolver problemas comunes.
...
2. Inicia una conversacion desde la pantalla principal.
3. Escribe como te sientes hoy o que necesitas resolver.
...
# 4. Como usar el chat de forma efectiva
...
Si necesitas ayuda con el uso de la plataforma, contacta al canal de soporte definido por tu organizacion.
...
- Si hay riesgo inmediato, prioriza ayuda humana de emergencia.

\newpage

# Aviso importante

Este documento es informativo y de apoyo de uso.  
No sustituye atencion medica, psicologica ni legal profesional.
