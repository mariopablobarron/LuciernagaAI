...
const cspDirectives = [
  "default-src 'self'",
  `script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://connect.facebook.net https://eu-assets.i.posthog.com https://us-assets.i.posthog.com https://cdn.inspectlet.com https://analytics.hubstartidea.es${isDev ? " 'unsafe-eval'" : ""}`,
  "style-src 'self' 'unsafe-inline'",
  "img-src 'self' data: blob: https:",
  "font-src 'self' https://cdn.jsdelivr.net",
  `connect-src 'self' https://openrouter.ai https://*.sentry.io https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://www.facebook.com https://accounts.google.com https://oauth2.googleapis.com https://eu.i.posthog.com https://us.i.posthog.com https://hn.inspectlet.com https://analytics.hubstartidea.es${isDev ? " ws://localhost:3000 ws://127.0.0.1:3000" : ""}`,
