  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-[9998] flex items-center justify-center w-12 h-12 rounded-full bg-violet-600 hover:bg-violet-500 text-white shadow-lg shadow-violet-500/25 transition-all focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
      >
      ...
      {open && (
        <div
          ...
          aria-modal="true"
          className="fixed bottom-20 left-6 z-[9998] w-80 max-h-[80vh] overflow-y-auto rounded-2xl border border-zinc-700 bg-zinc-900 shadow-2xl shadow-black/40"
        >
          {/* Header */}
