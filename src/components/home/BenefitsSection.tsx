...
const benefits = [
  {
    ...
    description: "Entiende qué te frena. Identifica patrones que no veías. Toma decisiones desde la honestidad.",
    highlight: "Menos confusión. Más dirección.",
  },
  {
    icon: Zap,
    title: "Energía renovada",
    description: "Cuando empiezas a actuar, la energía vuelve. Pequeñas acciones generan grandes cambios.",
    highlight: "De la parálisis a la acción.",
  },
  {
    icon: Target,
    title: "Hábitos que funcionan",
    description: "Olvida dietas extremas y regímenes imposibles. Pequeños cambios consistentes que se quedan.",
    highlight: "Transformación duradera.",
  },
  {
    icon: Heart,
    title: "Mejor relación contigo",
    description: "Dejas de luchar contra ti mismo. Empiezas a acompañarte. La autocompasión es el cambio real.",
    highlight: "Paz interna genuina.",
  },
  {
    icon: TrendingUp,
    title: "Crecimiento visible",
    description: "Semana tras semana ves tu progreso. Datos reales de tu transformación. Evidencia de cambio.",
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm font-semibold text-emotion-clarity">
                  {benefit.highlight}
                </p>
              </div>
            );
