...
const testimonials = [
  {
    ...
    role: "Estudiante",
    content:
      "Pensé que necesitaba un cambio masivo. Tres Mil Millones de Latidos me mostró que pequeñas acciones diarias son lo que funciona. En 3 semanas cambié mi hábito de sueño.",
    avatar: "👩",
  },
  {
    name: "Carlos, 28 años",
    role: "Emprendedor",
    content:
      "Tenía 10 hábitos que quería cambiar. Me sentía paralizado. Tres Mil Millones de Latidos me hizo enfocarse en uno. Ahora tengo 4 hábitos nuevos sin sentir presión.",
    avatar: "👨",
  },
  {
    name: "Sofía, 22 años",
  ...
  },
  {
    ...
    role: "Diseñador",
    content:
      "He probado apps, libros, coaches. Nada funcionaba. Tres Mil Millones de Latidos es diferente porque realmente te conoce. Los insights que me da son precisos.",
    avatar: "🧑‍🎨",
  },
];
