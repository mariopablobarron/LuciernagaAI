...
export function AuthShell({ title, description, children, eyebrow = "Acceso" }: AuthShellProps) {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_color-mix(in_oklab,var(--accent)_14%,transparent),transparent_28%),linear-gradient(180deg,color-mix(in_oklab,var(--background)_95%,white_5%),var(--background))] p-4 text-foreground md:p-6">
            ...
            <section className="border-b border-border bg-[linear-gradient(180deg,color-mix(in_oklab,var(--card)_55%,black_45%),color-mix(in_oklab,var(--card)_80%,black_20%))] px-8 py-10 text-white lg:border-r lg:border-b-0">
              <div className="flex items-start justify-between gap-4">
                <div className="flex flex-wrap items-center gap-2">
                  <Badge variant="secondary" className="gap-1 rounded-full bg-white/10 px-3 py-1 text-white">
