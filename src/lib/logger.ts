...
export const logDb = {
  ...
  warn: (message: string, meta?: Record<string, unknown>) => logInfo("DB", message, meta),
  error: (message: string, meta?: Record<string, unknown>) =>
