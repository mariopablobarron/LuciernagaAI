...
export const ONBOARDING_EXAMPLE_PROMPTS = [
  ...
  {
    label: "Elegir una prioridad",
    value: "Estoy dando vueltas y no decido cuál es mi prioridad real.",
  },
  {
    label: "Volver a una rutina",
    value: "Sé que necesito retomar una rutina, pero no consigo arrancar.",
  },
];
