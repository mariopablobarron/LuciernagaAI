...
export function shouldSilenceAdminLoops(input: {
  ...
  reason: "protest" | "repeated_action_lock" | "repeated_email" | "crisis" | null;
} {
  ...
  return {
    silenceActionLock: actionRepeats >= 2,
    silenceEmailPrompt: emailRepeats >= 2,
    reason:
      actionRepeats >= 2 ? "repeated_action_lock" : emailRepeats >= 2 ? "repeated_email" : null,
  };
}
